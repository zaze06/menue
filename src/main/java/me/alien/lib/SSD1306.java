...
public class SSD1306 {
    ...
    public void setDisplayStartLine(byte line) {
    ...
    public void setDisplayComOffset(byte offset) {
    ...
    public void setMemoryAddressMode(byte mode) {
    ...
    public void setColumnAddress(byte start, byte end) {
